...
<head>
    ...
    <%--  web路径
            不以/开始的相对路径，找资源以当前资源的路径为基准，经常容易出错
            以/开始的相对路径，找资源以服务器的路径为基准
    ...
    <script type="text/javascript">
        ...
        function validate_add_form() {
            ...
            if (!regEmail.test(email)) {
                ...
                // $("#email_add_input").next("span").text("邮箱不正确");
                return false;
            } else {
